...
function preload(){
   ...
   guyamin= loadAnimation("Walking Frame/walking_1.png","Walking Frame/walking_2.png","Walking Frame/walking_3.png","Walking Frame/walking_4.png","Walking Frame/walking_5.png","Walking Frame/walking_6.png","Walking Frame/walking_7.png","Walking Frame/walking_8.png");
}
...
function setup(){
    ...
    //create drops
    guy=createSprite(10,560);
    guy.scale=0.4;
    guy.addAnimation("walking",guyamin);
    guy.velocityX= 1.01;
    guy.lifetime= 200;
    ...
    if(frameCount%130 ===0){
        for(var i=0; i<maxDrops; i++){
            dropswater.push(new Drops(random(0,400), random(0,400)));
        }
    }
}
